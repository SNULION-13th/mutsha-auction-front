...
function AuctionRoomPage() {
  ...
  if (error || !auction) {
    return (
      <div className="w-full px-4 md:px-10 lg:px-50 pt-40">
  ...
  return (
    <div className="w-full px-4 md:px-10 lg:px-50 py-6 md:py-12 lg:py-30">
      <div className="max-w-[1062px] mx-auto flex flex-col gap-8 md:gap-16 lg:gap-25">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row gap-6 lg:gap-9">
          <div className="w-full lg:w-[470px] shrink-0 lg:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-5 shadow-xl">
            <img
              src={String(auction.image_file)}
              className="w-full h-[300px] sm:h-[392px] object-cover rounded-t-2xl"
            />
            <div className="px-4 py-5 md:px-7 pb-8 md:pb-12 flex flex-col gap-4 md:gap-6">
          ...
          <div className="w-full lg:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-10 md:gap-14 shadow-xl p-6 md:p-10 lg:px-12.5 lg:py-20 justify-center">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                  <div className="relative flex-1">
                    <input
                      ...
                      placeholder={
                        isEnded ? "이미 종료된 경매" : "입찰가 입력"
                      }
                      className={`w-full h-12 rounded-sm border border-scale-200 px-4 placeholder:text-scale-300 focus:outline-none ${
                        isEnded
                          ? "bg-scale-100 text-scale-300 cursor-not-allowed"
                          : "text-scale-600 focus:ring-2 focus:ring-brand-primary/40"
                      }`}
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-lg md:text-xl text-scale-600">
                      잔
                    </span>
                  </div>
                  {isEnded ? (
                    <Button
                      variant="darkgray"
                      className="h-12 w-full sm:w-auto px-6 flex gap-2.5 items-center justify-center cursor-not-allowed"
                    >
                      경매 종료
                    </Button>
                  ) : (
                    ...
                    >
                      <Button
                        ...
                        className="h-12 w-full sm:w-auto px-6 flex gap-2.5 items-center justify-center"
                      >
