  ...
  return (
    <div className="w-full px-5 py-10 md:px-50 md:py-30">
      <div className="max-w-[1062px] mx-auto flex flex-col gap-10 md:gap-25">
        ...
        <div className="w-full h-full flex flex-col md:flex-row gap-6 md:gap-9">
          <div className="w-full md:w-[470px] shrink-0 min-h-auto md:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-5 shadow-xl">
            <img
              src={String(auction.image_file)}
              className="w-full h-[300px] md:h-[392px] object-cover rounded-t-2xl"
            />
          ...
          <div className="w-full min-h-auto md:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-8 md:gap-14 shadow-xl px-6 py-8 md:px-12.5 md:py-20 justify-center">
