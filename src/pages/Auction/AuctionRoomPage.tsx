// src/pages/Auction/AuctionRoomPage.tsx
...
function AuctionRoomPage() {
  ...
  if (error || !auction) {
    return (
      <div className="w-full px-6 py-20 lg:px-50 lg:pt-40">
  ...
  return (
    ...
    <div className="w-full px-6 py-10 md:px-20 md:py-20 lg:px-50 lg:py-30">
      <div className="max-w-[1062px] mx-auto flex flex-col gap-10 lg:gap-25">
        ...
        {/* [변경] Flex 방향 및 Gap 조정 */}
        <div className="w-full h-full flex flex-col lg:flex-row gap-6 lg:gap-9">
          {/* [변경] 이미지 영역 너비 w-full -> lg:w-[470px] */}
          <div className="w-full lg:w-[470px] shrink-0 min-h-[400px] lg:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-5 shadow-xl overflow-hidden">
            <img
              src={String(auction.image_file)}
              className="w-full h-[250px] md:h-[350px] lg:h-[392px] object-cover"
            />
            <div className="px-6 lg:px-7 py-5 pb-8 lg:pb-12 flex flex-col gap-4 lg:gap-6">
              <div className="text-xl lg:text-2xl font-bold text-scale-600">
                {auction.title}
              </div>
              <div className="text-base lg:text-lg text-scale-400">
                {auction.description}
              </div>
            </div>
          </div>
          ...
          {/* [변경] 상세 정보 영역 패딩 조정 */}
          <div className="w-full min-h-[400px] lg:min-h-[577px] rounded-2xl bg-bg-white flex flex-col gap-10 lg:gap-14 shadow-xl px-6 py-10 md:px-10 lg:px-12.5 lg:py-20 justify-center">
            <div className="flex flex-col gap-4">
              <div className="text-2xl lg:text-3xl font-bold text-scale-600">경매 정보</div>
              <div className="flex items-center justify-between">
                <div className="text-lg lg:text-xl font-bold text-scale-500">
                  현재 입찰가
                </div>
                <div className="flex items-center gap-2 lg:gap-3">
                  <img src={Cup} className="w-8 lg:w-10" />
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-xl lg:text-2xl font-bold text-scale-500">
                  {getRemainingTime(auction.end_time)}
                </div>
              </div>
              <div className="flex items-center w-full py-2.5 gap-4">
                <div className="flex-1 flex flex-col gap-1.5">
                  <div className="text-lg lg:text-xl font-bold text-scale-500">
                    최소 입찰가
                  </div>
                  <div className="text-lg lg:text-xl text-scale-400">
                    {auction.starting_price}
                  </div>
                </div>
                <div className="flex-1 flex flex-col gap-1.5">
                  <div className="text-lg lg:text-xl font-bold text-scale-500">판매자</div>
                  <div className="text-lg lg:text-xl text-scale-400 truncate">
            ...
            <div className="flex flex-col gap-5 lg:gap-7">
              <div className="text-2xl lg:text-3xl font-bold text-scale-600">입찰하기</div>
              <div className="flex flex-col gap-2">
                {/* [변경] 입찰 인풋/버튼 모바일에서 세로 배치 또는 크기 조정 */}
                <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
                  <div className="flex flex-1 items-center gap-3">
                    <input
                      ...
                      className={`flex-1 w-full h-12 rounded-sm border border-scale-200 px-4 placeholder:text-scale-300 focus:outline-none ${
                        isEnded
                          ? "bg-scale-100 text-scale-300 cursor-not-allowed"
                          : "text-scale-600 focus:ring-2 focus:ring-brand-primary/40"
                      }`}
                    />
                    <span className="text-xl text-scale-600 whitespace-nowrap">잔</span>
                  </div>
                  
                  {isEnded ? (
                    <Button
                      variant="darkgray"
                      className="h-12 w-full md:w-50 px-6 flex gap-2.5 items-center justify-center cursor-not-allowed"
                    >
                      경매 종료
                    </Button>
                  ) : (
                    ...
                    >
                      <Button
                        ...
                        className="h-12 w-full md:w-50 px-6 flex gap-2.5 items-center justify-center"
                      >
