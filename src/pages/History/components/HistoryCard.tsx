...
export function HistoryCard({
  ...
  return (
    <div
      className={`w-full h-full flex flex-col rounded-xl shadow-lg px-6 py-4 md:px-15 md:py-7.5 gap-4 md:gap-6 ${
    ...
    >
      ...
      {ended ? (
        <div className="w-full h-full flex flex-col gap-2 md:gap-2.5">
          <div className="w-full flex justify-between">
            <div className="text-sm md:text-base font-bold text-scale-400">
              경매 종료
            </div>
            <div className="text-lg md:text-xl font-bold text-scale-600">
              {current_price}잔
            </div>
          </div>
      ...
      <Button
        ...
        className="w-full flex gap-2.5 rounded-sm p-2 md:p-2.5 items-center justify-center"
        onClick={handleClick}
      >
        {ended ? null : <img src={LogoWhite} className="w-3 md:w-4" />}
        <div
