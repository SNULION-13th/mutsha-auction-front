...
function AuctionCreatePage() {
  ...
  return (
    ...
    <div className="w-full px-6 py-10 md:px-20 md:py-20 lg:px-50 lg:py-30">
      <div className="max-w-[973px] mx-auto flex flex-col gap-10 lg:gap-25">
        <div className="flex flex-col gap-3 lg:gap-5 text-center lg:text-left">
          <div className="text-3xl lg:text-5xl font-bold text-scale-600">경매 등록하기</div>
        ...
        <form
          ...
          // [변경] 폼 내부 패딩 및 Gap 반응형 적용
          className="w-full rounded-2xl bg-bg-white flex flex-col gap-12 lg:gap-25 shadow-xl px-6 py-10 md:px-16 md:py-16 lg:px-35 lg:py-22.5"
        >
          <div className="grid grid-cols-1 gap-8 lg:gap-12">
            ...
            {/* [변경] Flex 방향을 모바일에서 col로 변경 */}
            <div className="w-full flex flex-col md:flex-row justify-between gap-8 md:gap-10">
