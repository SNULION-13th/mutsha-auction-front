    ...
    <div className="w-full px-4 pc:px-50 py-10 pc:py-30">
      <div className="max-w-[973px] mx-auto flex flex-col gap-25">
        ...
        <form
          ...
          className="w-full rounded-2xl bg-bg-white flex flex-col gap-25 shadow-xl px-4 pc:px-35 py-10 pc:py-22.5"
        >
          <div className="grid grid-cols-1 gap-12">
            ...
            <div className="w-full flex flex-col pc:flex-row pc:justify-between gap-10">
